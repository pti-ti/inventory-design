...
const MaintenanceModal = ({ open, handleClose, maintenance, refreshMaintenances }) => {
    ...
    useEffect(() => {
        if (open && isEditing && maintenance) {
            setDeviceCodeInput(maintenance.deviceCode || "");
            setEmailInput(maintenance.userEmail || "");
        }
    }, [open, isEditing, maintenance]);
            ...
            <Modal open={open} onClose={handleCloseModal}>
                <Box sx={{
                    ...
                    <Autocomplete
                        ...
                        renderInput={(params) => (
                            <TextField {...params} fullWidth margin="normal" label="Mantenimiento solicitado por:" />
                        )}
                    />
